...
export function loadConfig() {
    ...
    const cleanConfig = Object.fromEntries(Object.entries(rawConfig).filter(([_, value]) => value !== undefined));
    try {
...
export { SUPPORTED_CLOUD_TYPES, SOURCE_TYPES, RESULT_TYPES, validateCloudTypes, validateSourceType, validateResultType } from './validators.js';
