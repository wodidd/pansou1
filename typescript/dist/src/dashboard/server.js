...
export class DashboardServer {
    constructor(testRunner, statusStore, config) {
        this.server = null;
    ...
    setupRoutes() {
        // 获取状态
        this.app.get('/dashboard/status', (req, res) => {
            try {
        ...
        // 手动触发测试运行
        this.app.post('/dashboard/run', async (req, res) => {
            try {
                // 检查是否已有测试在运行
